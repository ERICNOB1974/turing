...
public class TipoTurnoService {
    ...
    public TipoTurno obtenerTurno(int operarioLegajo, Date fecha){
        return repository.obtenerTurno(operarioService.findByLegajo(operarioLegajo),fecha);
    }

    public LocalTime obtenerHoraDesde(Operario operario, Date fecha) {
        TipoTurno tipoTurno = obtenerTurno(operario.getLegajo(), fecha);
    ...
    public Horario obtenerHorario(int operarioLegajo, Date fecha) {
        TipoTurno tipoTurno = obtenerTurno(operarioLegajo, fecha);
